# http://www.codeskulptor.org/#user44_7HIUaC66At_0.py
# http://www.codeskulptor.org/#user44_ePDSC5Jj5A_29.py
# http://www.codeskulptor.org/#user44_ePDSC5Jj5A_55.py
# http://www.codeskulptor.org/#user44_SwLb1VPrRE_6.py
# http://www.codeskulptor.org/#user44_SwLb1VPrRE_8.py
...
def rock_spawner():    
    ...
    n_rot = sign * random.random() / 10
    sign_angle = random.choice([-1,1])
    angle = sign_angle * random.random() / 10
    sign_x = random.choice([-1,1])
    x_pos = sign_x * random.random()
    sign_y = random.choice([-1,1])
    y_pos = sign_y * random.random()
    a_rock = Sprite([WIDTH / n, HEIGHT / n], [x_pos, y_pos], angle, n_rot, asteroid_image, asteroid_info)
